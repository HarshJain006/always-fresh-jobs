  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "DailyResume — Automated daily resume refresh" },
      {
        ...
        content:
          "Upload your resume once. We refresh it daily across Naukri, Indeed and LinkedIn so your profile stays active and visible.",
      },
      ...
      { name: "apple-mobile-web-app-title", content: "DailyResume" },
    ],
    links: [
